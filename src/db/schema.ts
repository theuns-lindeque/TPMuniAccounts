...
export const utilityAccountsRelations = relations(
  utilityAccounts,
  ({ one }) => ({
...
export const invoices = pgTable("invoices", {
  id: text("id").primaryKey(),
  utilityAccountId: text("utility_account_id")
...
export const analysisReports = pgTable("analysis_reports", {
  ...
  buildingId: text("building_id")
    ...
    .notNull(),
  period: date("period").notNull(),
  totalInvoiceAmount: numeric("total_invoice_amount", {
    precision: 12,
    scale: 2,
  }).notNull(),
  totalRecoveryAmount: numeric("total_recovery_amount", {
    precision: 12,
    scale: 2,
  }).notNull(),
...
export const feedbackLoop = pgTable("feedback_loop", {
  id: text("id").primaryKey(),
  analysisReportId: text("analysis_report_id")
